...
Java_com_commonlauncher_nativeplugin_jni_PluginNative_getGLExtensions(JNIEnv *env, jclass clazz) {
...
Java_com_commonlauncher_nativeplugin_jni_PluginNative_getGPUTemperature(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jfloat JNICALL
Java_com_commonlauncher_nativeplugin_jni_PluginNative_getGPUFrequency(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jfloat JNICALL
Java_com_commonlauncher_nativeplugin_jni_PluginNative_getVRAMUsage(JNIEnv *env, jclass clazz) {
